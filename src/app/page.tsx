    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-20 pt-20">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/b451115a-4efe-44ef-a3dd-8a3d752bebb7.webp"
            alt="Background"
            fill
              ...
              <Button variant="outline" size="lg" className="flex items-center gap-2">
                ...
                Available for new projects
                    ...
                    <div className="flex gap-6 justify-center">
                      <a href="mailto:anurag@example.com" className="text-muted-foreground hover:text-primary transition-colors">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                      </a>
                      <a href="https://calendly.com/anurag" className="text-muted-foreground hover:text-primary transition-colors">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                      </a>
                      <a href="https://github.com/anurag" className="text-muted-foreground hover:text-primary transition-colors">
                      ...
                      <a href="https://huggingface.co/anurag" className="text-muted-foreground hover:text-primary transition-colors">
                      ...
                      <a href="https://x.com/anurag" className="text-muted-foreground hover:text-primary transition-colors">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold">Recent Log</h2>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button variant="ghost" size="sm" asChild className="group-hover:bg-primary/10">
                    <Link href="/blog/building-modern-web-apps">Read More</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
            <Card className="hover:shadow-lg hover:border-primary/50 transition-all duration-200 group">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Principles and practices for writing maintainable and readable code...
                </p>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Dec 10, 2024</span>
                  <Button variant="ghost" size="sm" asChild className="group-hover:bg-primary/10">
                    <Link href="/blog/art-of-clean-code">Read More</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
